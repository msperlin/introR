...
Download TESLA (TSLA) stock data with the `yfR` package for the last 500 days. Display the price line chart adjusted over time using the `r introR::format_fct_text("ggplot")` function. Make sure that:
